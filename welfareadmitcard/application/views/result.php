...
<head>
		<title>PGC Ghazipur Result 2017</title>
		<meta charset="UTF-8" />
	...
	<body>
		...
		<div id="main-content" class="container full-width">
			<div class="content">
				<div class="wrapper">
					<div class="form">
						<form method="post" action="<?php echo base_url(); ?>index.php/welcome/getResult" id="step1">
                            <h2 style="text-align:center;font-weight:bold;">Result Entrance Exam-2017</h2>
