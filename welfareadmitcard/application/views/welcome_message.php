	...
	<body>
		...
		<div id="main-content" class="container full-width">
			<div class="content">
				<div class="wrapper">
					<div class="form">
						<form method="post" action="<?php echo base_url(); ?>index.php/welcome/getAdmit" id="step1">
                            <h2 style="text-align:center;font-weight:bold;">Download Admit card for Entrance Exam-2017</h2>
                                                        <div class="course-div" style="padding:40px;">
								<label>Registration Number</label>
								<input type="text" name="regnumber" value="" required>
                                 <input type="submit" name="submit" value="Submit">

<div >  <font size="4" color="red"> <?php if($msg==7){
